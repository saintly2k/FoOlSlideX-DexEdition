<div class="col-span-12">
    <h1 class="text-2xl border-b mb-1">Popular Titles</h1>
    <div class="grid grid-cols-8 gap-2">
        <?php for ($i = 1; $i <= config("home_display_titles"); $i++) { ?>
            <div class="col-span-1">
                <div role="status" class="animate-pulse">
                    ...
                    <div class="h-[0.89rem] bg-gray-200 rounded-full mt-1 w-full"></div>
                </div>
            </div>
        <?php } ?>
    </div>
...
<div class="col-span-12">
    <h1 class="text-2xl border-b mb-1">Recent Chapters</h1>
